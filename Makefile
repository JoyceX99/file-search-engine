#############################################################################
# Makefile for building: FileSearchUI.app/Contents/MacOS/FileSearchUI
# Generated by qmake (2.01a) (Qt 4.8.6) on: Wed Nov 25 17:38:31 2015
# Project:  FileSearchUI.pro
# Template: app
# Command: /usr/local/bin/qmake -o Makefile FileSearchUI.pro
#############################################################################
...
SOURCES       = main.cpp \
		finder.cpp \
		listdelegate.cpp moc_finder.cpp
OBJECTS       = main.o \
		finder.o \
		listdelegate.o \
		moc_finder.o
DIST          = /usr/local/Cellar/qt/4.8.6/mkspecs/common/unix.conf \
		...
		FileSearchUI.pro
QMAKE_TARGET  = FileSearchUI
DESTDIR       = 
TARGET        = FileSearchUI.app/Contents/MacOS/FileSearchUI
...
all: Makefile FileSearchUI.app/Contents/PkgInfo FileSearchUI.app/Contents/Resources/empty.lproj FileSearchUI.app/Contents/Info.plist $(TARGET)

$(TARGET): ui_finder.h $(OBJECTS)  
	@$(CHK_DIR_EXISTS) FileSearchUI.app/Contents/MacOS/ || $(MKDIR) FileSearchUI.app/Contents/MacOS/ 
	$(LINK) $(LFLAGS) -o $(TARGET) $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: FileSearchUI.pro  /usr/local/Cellar/qt/4.8.6/mkspecs/unsupported/macx-clang-libc++/qmake.conf /usr/local/Cellar/qt/4.8.6/mkspecs/common/unix.conf \
		/usr/local/Cellar/qt/4.8.6/mkspecs/common/mac.conf \
		/usr/local/Cellar/qt/4.8.6/mkspecs/common/gcc-base.conf \
		/usr/local/Cellar/qt/4.8.6/mkspecs/common/gcc-base-macx.conf \
		/usr/local/Cellar/qt/4.8.6/mkspecs/common/clang.conf \
	...
	$(QMAKE) -o Makefile FileSearchUI.pro
...
FileSearchUI.app/Contents/PkgInfo: 
	@$(CHK_DIR_EXISTS) FileSearchUI.app/Contents || $(MKDIR) FileSearchUI.app/Contents 
	@$(DEL_FILE) FileSearchUI.app/Contents/PkgInfo
	@echo "APPL????" >FileSearchUI.app/Contents/PkgInfo
FileSearchUI.app/Contents/Resources/empty.lproj: 
	@$(CHK_DIR_EXISTS) FileSearchUI.app/Contents/Resources || $(MKDIR) FileSearchUI.app/Contents/Resources 
	@touch FileSearchUI.app/Contents/Resources/empty.lproj
	
FileSearchUI.app/Contents/Info.plist: 
	@$(CHK_DIR_EXISTS) FileSearchUI.app/Contents || $(MKDIR) FileSearchUI.app/Contents 
	@$(DEL_FILE) FileSearchUI.app/Contents/Info.plist
	@sed -e "s,@SHORT_VERSION@,1.0,g" -e "s,@TYPEINFO@,????,g" -e "s,@ICON@,,g" -e "s,@EXECUTABLE@,FileSearchUI,g" -e "s,@TYPEINFO@,????,g" /usr/local/Cellar/qt/4.8.6/mkspecs/unsupported/macx-clang-libc++/Info.plist.app >FileSearchUI.app/Contents/Info.plist
dist: 
	@$(CHK_DIR_EXISTS) .tmp/FileSearchUI1.0.0 || $(MKDIR) .tmp/FileSearchUI1.0.0 
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/FileSearchUI1.0.0/ && $(COPY_FILE) --parents finder.h listdelegate.h .tmp/FileSearchUI1.0.0/ && $(COPY_FILE) --parents main.cpp finder.cpp listdelegate.cpp .tmp/FileSearchUI1.0.0/ && $(COPY_FILE) --parents finder.ui .tmp/FileSearchUI1.0.0/ && (cd `dirname .tmp/FileSearchUI1.0.0` && $(TAR) FileSearchUI1.0.0.tar FileSearchUI1.0.0 && $(COMPRESS) FileSearchUI1.0.0.tar) && $(MOVE) `dirname .tmp/FileSearchUI1.0.0`/FileSearchUI1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/FileSearchUI1.0.0
...
moc_finder.cpp: finder.h
	/usr/local/Cellar/qt/4.8.6/bin/moc $(DEFINES) $(INCPATH) -D__APPLE__ -D__GNUC__ finder.h -o moc_finder.cpp
...
compiler_uic_make_all: ui_finder.h
compiler_uic_clean:
	-$(DEL_FILE) ui_finder.h
ui_finder.h: finder.ui
	/usr/local/Cellar/qt/4.8.6/bin/uic finder.ui -o ui_finder.h
...
listdelegate.o: listdelegate.cpp listdelegate.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o listdelegate.o listdelegate.cpp
